...
const alien1 = aliens.find((alien1)=>{
return alien1.name == "Cucushumushu"
});

const mutador = mutations.find((mutador) =>{
return mutador.name== "Porompompero"

});

const alien ={...alien1, mutacion:{ ...mutador} };
console.log(alien);